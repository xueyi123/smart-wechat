package com.starbuy.wechat.sdk.api;

import com.starbuy.wechat.sdk.kit.PaymentKit;
import com.starbuy.wechat.sdk.utils.HttpUtils;
...
///////////////
	 ...
	 * @param params 请求参数
	 * @param paternerKey 支付密钥 （在企业账号里设置）
     * @return
     */
	private static  String mmPayMkTransfersURL = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers" ;
	public static  Map<String, String> mmPayMktTransfers(Map<String, String> params,String paternerKey,String certPath){
		params.put("nonce_str", System.currentTimeMillis() + "");
		String sign = PaymentKit.createSign(params, paternerKey);
		params.put("sign", sign);
		String partner = params.get("mchid");//注意：不是mch_id哦
		String xmlStr = HttpUtils.postSSL(mmPayMkTransfersURL, PaymentKit.toXml(params), certPath, partner);
		return PaymentKit.xmlToMap(xmlStr);
	}

	/**
	 * 参考文档：https://pay.weixin.qq.com/wiki/doc/api/tools/mch_pay.php?chapter=14_3
     ...
     * @return
     */
	private static String getMmPayMkTransfersURL = "https://api.mch.weixin.qq.com/mmpaymkttransfers/gettransferinfo" ;
	public static  Map<String, String> getMmPayTransferInfo(Map<String, String> params,String paternerKey,String certPath){
		params.put("nonce_str", System.currentTimeMillis() + "");
		String sign = PaymentKit.createSign(params, paternerKey);
		int d=0;//
		params.put("sign", sign);
		String partner = params.get("mch_id");
		String xmlStr = HttpUtils.postSSL(getMmPayMkTransfersURL, PaymentKit.toXml(params), certPath, partner);
		return PaymentKit.xmlToMap(xmlStr);
	}
