...
import com.starbuy.wechat.sdk.cache.IAccessTokenCache;
...
public class AccessTokenApi {
	...
	public static synchronized void refreshAccessToken() {
		...
		final Map<String, String> queryParas = ParaMap.create("appid", appId).put("secret", appSecret).put("grant_type","client_credential").getData();
