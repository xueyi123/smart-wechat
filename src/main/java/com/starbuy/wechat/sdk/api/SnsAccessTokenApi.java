...
import com.starbuy.wechat.sdk.utils.RetryUtils;
...
public class SnsAccessTokenApi
{
    ...
    {
        final Map<String, String> queryParas = ParaMap.create("appid", appId).put("secret", secret).put("code", code).put("grant_type","authorization_code").getData();
