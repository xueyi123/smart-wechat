...
public class QrcodeApi
{
	...
	/**
	 * 获取临时公众号二维码地址
	 * @param sceneId 场景ID,相当于二维码参数，32位整形
	 * @return 返回临时二维码，有效期1天
     */
	public static String getTmpQrcodeUrl(int sceneId ){
		ApiResult apiResult = QrcodeApi.createTemporary(86400,sceneId);
