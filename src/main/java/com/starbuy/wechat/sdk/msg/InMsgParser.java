...
package com.starbuy.wechat.sdk.msg;

import com.starbuy.wechat.sdk.msg.in.*;
import com.starbuy.wechat.sdk.msg.in.event.*;
import com.starbuy.wechat.sdk.msg.in.event.InShakearoundUserShakeEvent.AroundBeacon;
import com.starbuy.wechat.sdk.msg.in.speech_recognition.InSpeechRecognitionResults;
import com.starbuy.wechat.sdk.utils.XmlHelper;
...
public class InMsgParser {
	static Logger logger = Logger.getLogger(InMsgParser.class);
	private InMsgParser() {}
	...
	private static InMsg parseInEvent(XmlHelper xmlHelper, String toUserName, String fromUserName, Integer createTime, String msgType) {
		...
		if ("subscribe".equals(event) && !StringUtils.isBlank(eventKey) && eventKey.startsWith("qrscene_")) {
