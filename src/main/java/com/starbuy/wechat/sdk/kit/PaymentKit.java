...
import com.starbuy.wechat.sdk.utils.Charsets;
import com.starbuy.wechat.sdk.utils.MD5;
...
public class PaymentKit {
	...
	/**
	 * 生成签名(用户支付或企业支付相关的接口签名)
	 * @param params 参数
	 * @param paternerKey 支付密钥（payKey）
	 * @return sign
	 */
	public static String createSign(Map<String, String> params, String paternerKey) {
		...
		MD5 md5 = new MD5();
		return md5.getMD5ofStr(stringSignTemp).toUpperCase();
	}
